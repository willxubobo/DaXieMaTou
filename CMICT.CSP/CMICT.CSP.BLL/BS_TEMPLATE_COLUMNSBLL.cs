...
namespace CMICT.CSP.BLL
{
	...
	public partial class BS_TEMPLATE_COLUMNSBLL
	{
		...
		public bool Add(CMICT.CSP.Model.BS_TEMPLATE_COLUMNS model)
		{
            ...
            strSql.Append("ID,TemplateID,ColumnName,ColumnDataType,Visiable,DisplayName,MergeColumnName,Sequence,Created,Modified,Author,Editor)");
            ...
            SqlParameter[] parameters = {
					...
					new SqlParameter("@ColumnDataType", SqlDbType.NVarChar,50),
            ...
            parameters[3].Value = model.ColumnDataType;
            parameters[4].Value = model.Visiable;
            parameters[5].Value = model.DisplayName;
            parameters[6].Value = model.MergeColumnName;
            if (model.Sequence == -1) {
		...
		public bool Update(CMICT.CSP.Model.BS_TEMPLATE_COLUMNS model)
		{
            ...
            strSql.Append("ColumnDataType=@ColumnDataType,");
		...
		public CMICT.CSP.Model.BS_TEMPLATE_COLUMNS GetModel(Guid ID)
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 * from BS_TEMPLATE_COLUMNS ");
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
                                            new SqlParameter("@ID", SqlDbType.UniqueIdentifier,16)
			};
        ...
        public CMICT.CSP.Model.BS_TEMPLATE_COLUMNS DataRowToModel(DataRow row)
        {
            ...
            if (row != null)
            {
                ...
                if (row["ColumnDataType"] != null)
                {
                    model.ColumnDataType = row["ColumnDataType"].ToString();
                }
