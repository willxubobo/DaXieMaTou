...
namespace CMICT.CSP.BLL
{
	...
	public partial class BS_TEMPLATE_MAINBLL
	{
		...
		/// 增加一条数据
		/// </summary>
		public string Add(CMICT.CSP.Model.BS_TEMPLATE_MAIN model)
		{
            Guid TemplateID = Guid.NewGuid();
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into BS_TEMPLATE_MAIN(");
            strSql.Append("TemplateID,SourceID,TemplateName,DiaplayType,TemplateDesc,BigCategory,SmallCategory,Unit,Reminder,PageSize,ColumnSize,TemplateStatus,SQL,Created,Modified,Author,Editor)");
