...
namespace CMICT.CSP.BLL
{
    ...
    public partial class UA_USAGEBLL
    {
        ...
        public bool Add(CMICT.CSP.Model.UA_USAGE model)
        {
            ...
            strSql.Append("ID,PageName,Url,TemplateID,TemplateName,LoadTime,Query,BrowserType,Created,Author)");
            ...
            parameters[7].Value = model.BrowserType;
        ...
        public CMICT.CSP.Model.UA_USAGE DataRowToModel(DataRow row)
        {
            ...
            if (row != null)
            {
                ...
                {
                    model.PageName = new Guid(row["PageName"].ToString());
                }
                if (row["Url"] != null)
                {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ID,PageName,Url,TemplateID,TemplateName,LoadTime,Query,BrowserType,Created,Author ");
