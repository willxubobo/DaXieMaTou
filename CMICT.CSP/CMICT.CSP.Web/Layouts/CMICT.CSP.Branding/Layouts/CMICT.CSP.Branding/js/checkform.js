...
function errorMsg(name,title)
{
      ...
      {
        document.getElementById('div'+ name).innerHTML = "<img width='16'  id='img" + name + "' src='/images/alert.ico'>" ;
...
//					return false;
		...
		if(MsgState == false)
		{
		    var cfurl = 'CheckFormMsg.htm';
		    $.layer({ type: 2, title: "  ", maxmin: false, border: [0], shadeClose: false, shade: [0.6, "#000"], area: ["400px", "300px"], offset: ["40px", ""], iframe: { src: cfurl, scrolling: "yes" } });
